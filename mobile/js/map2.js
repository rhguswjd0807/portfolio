 window.onload = function() {
    ...
    var options = {
        center: new daum.maps.LatLng(34.865225336804635, 128.70217726595578),
        level: 2
    };
    ...
    var markerPosition  = new daum.maps.LatLng(34.865225336804635, 128.70217726595578); 
    ...
    var options2 = {
        center: new daum.maps.LatLng(37.558126433003586, 126.97414745017046),
        level: 2
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(37.558126433003586, 126.97414745017046); 
   ...
   var options3 = {
       center: new daum.maps.LatLng(37.364964854611955,126.72548252535346),
       level: 2
   };
   ...
   var markerPosition3  = new daum.maps.LatLng(37.364964854611955,126.72548252535346); 
