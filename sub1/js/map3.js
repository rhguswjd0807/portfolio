 window.onload = function() {
    ...
    var options = {
        center: new daum.maps.LatLng(34.864813,128.703396),
        level: 2
    };
    ...
    var markerPosition  = new daum.maps.LatLng(34.864813,128.703396); 
    ...
    var options2 = {
        center: new daum.maps.LatLng(37.557852, 126.973705),
        level: 2
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(37.557852, 126.973705); 
   ...
   var options3 = {
       center: new daum.maps.LatLng(37.363248,126.723654),
       level: 2
   };
   ...
   var markerPosition3  = new daum.maps.LatLng(37.363248,126.723654); 
