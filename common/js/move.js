...
$(document).ready(function() {
    ...
    $('.gallery .link1 .spn1').delay(1500).animate({top:250, opacity:1},'slow');
    $('.gallery .link1 .spn2').delay(1500).animate({top:300, opacity:1},'slow');
    ...
    //   }
      ...
      $('.mbutton').css('background','#000'); //버튼불다꺼!!
      ...
      $('.gallery .link'+cnt).find('span').delay(1000).animate({top:250, opacity:1},'slow');
   ...
   $('.mbutton').click(function(event){  //각각의 버튼 클릭시
      ...
      //   $('.btn'+i).css('width','16');
		  // }
      $('.mbutton').css('background','#000'); //버튼 모두불꺼
